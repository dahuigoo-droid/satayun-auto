...
from saju_calculator import (
    ...
    calc_용신, calc_합충형파해, calc_천간합, calc_궁성, 
    calc_육친, calc_납음오행, calc_격국, calc_공망_전체
)
...
def 양력_to_음력(year, month, day):
    ...
    return calendar.lunarYear, calendar.lunarMonth, calendar.lunarDay, calendar.isIntercalation
...
def generate_gpt_text(사주, 기본정보, gender, 대운_data, 세운_data, 월운_data, 신살_data):
    """GPT 해석용 표준 텍스트 포맷 생성"""
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        시주        일주        월주        년주
천간    {시주[0]}          {일주[0]}          {월주[0]}          {년주[0]}
지지    {시주[1]}          {일주[1]}          {월주[1]}          {년주[1]}

일간: {일주[0]} (오행: {용신_data['일간_오행']})

■ 2. 대운표
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
대운수: {대운_data['대운수']}세 시작 | 방향: {'순행' if 대운_data['순행'] else '역행'}
"""
    
    for i, 대운 in enumerate(대운_data['대운'][:12]):
        text += f"{대운['나이']}세: {대운['천간']}{대운['지지']} | "
        if (i + 1) % 4 == 0:
            text += "\n"
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
    for 세운 in 세운_data['세운']:
        text += f"{세운['년도']}년: {세운['천간']}{세운['지지']} (천간십성:{세운['천간_십성']}, 지지십성:{세운['지지_십성']})\n"
    
    text += f"""
■ 4. 월운표 (12개월)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
    for 월운 in 월운_data['월운']:
        text += f"{월운['년도']}년 {월운['월']}월: {월운['천간']}{월운['지지']} (천간십성:{월운['천간_십성']}, 지지십성:{월운['지지_십성']})\n"
    
    text += f"""
■ 5. 오행분석
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
목:{오행['목']} 화:{오행['화']} 토:{오행['토']} 금:{오행['금']} 수:{오행['수']}
총합: {sum(오행.values())}개

■ 16. 용신표
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[신강/신약] {용신_data['신강약']} ({용신_data['신강점수']})
[조후용신] {용신_data['조후_용신']}
[억부용신] {용신_data['억부_용신']}
